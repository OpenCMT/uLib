...
ClassImp(muBlastMCTrack)

uLib::MuonScatter &operator << (uLib::MuonScatter &mu, const muBlastMCTrack &bsmu) {
...
muBlastMCTrack::muBlastMCTrack(TParticle* part)
{
...
void muBlastMCTrack::AddPoint(TLorentzVector pos, TLorentzVector mom)
{
