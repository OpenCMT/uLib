#ifndef muBlast_HIT_H
#define muBlast_HIT_H
...
/// \file muBlastHit.h
/// \brief Definition of the muBlastHit class 
///
...
class muBlastHit : public TObject
{
  public:
    muBlastHit();
    virtual ~muBlastHit();
  ...
  ClassDef(muBlastHit,1) //muBlastHit  
};

//} // Mutom
//} // ROOT

#endif //muBlastt_HIT_H
