...
//namespace ROOT {
//namespace Mutom {
class muBlastMCTrack : public TObject
{
 ...
 public:
  ...
  muBlastMCTrack(TParticle* particle);

  /**  Destructor  **/
  virtual ~muBlastMCTrack();
  void Reset();   
